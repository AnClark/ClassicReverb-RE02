#
# Classic Reverb RE-02 Makefile
#
# This Makefile is designed to automate the build and packaging process for the Classic Reverb RE-02 project.
...
PROJECT_NAME := $(shell grep -m1 '^[[:space:]]*project' CMakeLists.txt | awk '{print $$2}' | cut -c2-)
PROJECT_VERSION = $(shell grep -m1 '^[[:space:]]*VERSION' CMakeLists.txt | awk '{print $$2}')

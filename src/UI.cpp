...
// -----------------------------------------------------------------------
// Scale-mark definitions for each knob
...
void ClassicReverbUI::onImGuiDisplay()
{
    ...
    if (ImGui::Begin("Main Window", nullptr, window_flags))
    {
        ...
        // ── Transparent overlay child for controls ───────────────────────
    ...
    // ── "About" window ────────────────────────────────────────────────────
    static constexpr auto about_flags =
    ...
    if (fAboutWindowOpened)
    {
        ...
        if (ImGui::Begin("About Window", &fAboutWindowOpened, about_flags))
        {
            {
...

                {
                    ...
                    ImGui::TextWrapped("This is an unofficial, reverse-engineered clone of the discontinued "
                        "Kjaerhus Classic Reverb, aiming at bringing this vintage and fantastic plugin "
                        "to life again.");
...

            {
                ...
                ImGui::PushStyleColor(ImGuiCol_ButtonActive,
                    IM_COL32(0x2f + 20, 0x4d + 20, 0x44 + 20, 0xff));

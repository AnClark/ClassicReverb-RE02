...
{
    std::string name;
    float roomSize  = kParamRanges[kRoomSize].def;
    float damping   = kParamRanges[kDamping].def;
    float preDelay  = kParamRanges[kPreDelay].def;
    float hiDamp    = kParamRanges[kHiDamp].def;
    float loCut     = kParamRanges[kLoCut].def;
    float earlyRef  = kParamRanges[kEarlyReflection].def;
    float mix       = kParamRanges[kMix].def;
    float level     = kParamRanges[kLevel].def;
